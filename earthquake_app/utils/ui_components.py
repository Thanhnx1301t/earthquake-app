...
[data-testid="stSidebarNav"] a {
    ...
    margin: 1px 4px !important; color: #94a3b8 !important;
...
[data-testid="stSidebarNav"] a[aria-current="page"] {
    background: rgba(123,47,190,0.2) !important; color: #c084fc !important;
    border-left: 3px solid #7B2FBE !important; font-weight: 600 !important;
}
